...
SOUNDERROR SoundManager::InitializeCache(int size) { return (NO_SOUND_ERROR); }

SOUNDERROR SoundManager::FlushCache() { return (NO_SOUND_ERROR); }

SOUNDERROR SoundManager::SuspendMixer() { return (NO_SOUND_ERROR); }

SOUNDERROR SoundManager::RestoreMixer() { return (NO_SOUND_ERROR); }

SOUNDERROR SoundManager::PreLoadSound(DWORD wave) { return (NO_SOUND_ERROR); }
...
SOUNDERROR SoundManager::SetVolume(long volume) { return (NO_SOUND_ERROR); }

SOUNDERROR SoundManager::FadeOut() { return (NO_SOUND_ERROR); }

SOUNDERROR SoundManager::FadeIn() { return (NO_SOUND_ERROR); }
...
bool SoundManager::IsMixerFaded() { return false; }
