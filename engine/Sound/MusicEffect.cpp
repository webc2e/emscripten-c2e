...
MusicEffect::MusicEffect()
    : stages(NULL), currentStage(NULL), currentBeat(0.0) {}
...
// ----------------------------------------------------------------------
bool MusicEffect::ReadStage(MusicValue &volume, MusicValue &pan,
                            MusicValue &delay) {
...
// Returns:		Nothing
// Description:	Default Constructor
//				By default, a stage will be centred, full volume,
//and 				have a delay of one beat
// ----------------------------------------------------------------------
MusicEffect::Stage::Stage()
    : pan(0.0), randomPan(0.0), volume(1.0), randomVolume(0.0), delay(1.0),
      randomDelay(0.0), tempoDelay(true), nextStage(NULL) {}
...
// Returns:		Nothing
// Description:	Default Destructor
//				Deletes all elements after this in the linked
//list. 				Delete the entire list by deleting the first element
// ----------------------------------------------------------------------
MusicEffect::Stage::~Stage() {
...
//					          tempo related)
//				stageVolume - to contain ratio of stage volume to
//overall 						      sound volume 				stagePan    - to contain pan position (-1.0 to 1.0)
//				stageDelay  - time elapsed until next stage
// Returns:		Nothing
// Description:	Calculates the settings for this stage
// ----------------------------------------------------------------------
void MusicEffect::Stage::ReadSettings(MusicValue beat, MusicValue &stageVolume,
                                      MusicValue &stagePan,
