...
MusicTrack::MusicTrack()
    : beatOccurred(false), barOccurred(false), volume(1.0), initialVolume(1.0),
      fadeIn(2.0), fadeOut(2.0), playStatus(FadingIn), beatLength(0.0),
      initialBeatLength(0.0), barLength(4.0), beatCount(0.0), barCount(0.0),
      currentBeat(0.0) {}
...
// ----------------------------------------------------------------------
MusicError MusicTrack::Parse(MusicScript &script, MusicManager &manager) {
