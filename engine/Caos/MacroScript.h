...
public:
  ...
  //				DebugInfo object (if non-null) is transferred to
  // the 				MacroScript. ie the ownership of the DebugInfo is
  ...
  //				updates the address counter (addr)
  // appropriately.
  // ---------------------------------------------------------------------
  ...
  //				Should be used sparingly. NOTE: no bounds
  //checking
  ...
  //				script.
  // ---------------------------------------------------------------------
  void GetClassifier(Classifier &c) const { c = myClassifier; }
  ...
  //				script.
  // ---------------------------------------------------------------------
  void SetClassifier(const Classifier &c) { myClassifier = c; };
