...
// ----------------------------------------------------------------------
	...
	// ----------------------------------------------------------------------
	void SetAnim( const uint8_t* newanim=NULL, int length=0 );
	bool ValidateAnim( const uint8_t* newanim, int length=0 );
	...
	// ----------------------------------------------------------------------
	void SetFrameRate(const uint8_t rate = 1);
...
protected:
	...
	// Animation variables
	uint32		myAnim[ MaxAnimLength ]; // Expands the uint8_t's to 32's for efficience
