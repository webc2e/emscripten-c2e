...
#ifndef		DX_DISPLAYENGINE_H
#define		DX_DISPLAYENGINE_H

// DirectX version of DisplayEngine
...
////////////////////////////////////////////////////////////////////////////
	...
	void DrawAlphaCompressedSprite(Position& position,
					 CompressedBitmap* bitmap, int intensity);
...
//	static  bool FileBeingConverted(std::string& fileName);
	...
	void DrawGuttering(IDirectDrawSurface4* surfaceToDrawOn, int width, int height);
...
// ----------------------------------------------------------------------
	...
	void CreateUserInterfaceGalleries(	std::string const &transitionGallery);
