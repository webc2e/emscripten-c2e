...
//#define SECOND_TIMEOUT_DEFAULT 5000	// time to wait for request to be
//processed
...
public:
  ...
  //				size - size of request in bytes (need allow for
  //'\0' 				       char if sending text!)
  ...
  //				NOTE: this call effectively locks the server
  ...
  // Arguments:	None
  // Returns:		None
  // Description:	Unlocks the result buffer and allows the server to
  // accept
